...
==========================================================================
    ...
    if choice == 1:
        ...
        while True:
            ...
            if num_ing >= MAX_ING:
                ...
                print(
                    f"\nRemoving {oldest_ing['name']} from storage (added on {oldest_ing['day']}/{oldest_ing['month']}/{oldest_ing['year']})\n"
                )
                loadming(0.05, "loading")
                print()
                storage = storage[1:]
            ...
            if available == False:
                ...
                while True:
                    ...
                    try:
                        ...
                        print(
                            "Invalid date format, please enter date in format DD/MM/YYYY"
                        )
    ...
    if choice == 2:
        ...
        input_str = input(
            "\nEnter an ingredient name to remove from storage (or 'b' to back): "
        )
        if input_str == "b":
            break
        else:
    ...
    if choice == 3:
        ...
        if num_ing != 0:
            ...
            for ingredient in storage:
                ...
                print(
                    f"\t\"{ingredient['name']}\" added on {ingredient['day']}/{ingredient['month']}/{ingredient['year']}"
                )
        else:
            print("\nStorage Empty")
